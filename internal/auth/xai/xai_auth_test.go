...
func TestNewXAIAuthWithHTTPClient(t *testing.T) {
	...
	if defaultClient == nil || defaultClient.Transport != nil || defaultClient.Timeout != httpClientTimeout {
		t.Fatalf("expected default credential HTTP client, got %#v", defaultClient)
	}
}
